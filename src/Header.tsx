...
export default function Header() {
    return (
        <header className="flex justify-between">
            ...
            <div className="flex border border-gray-500 gap-2 shadow-md shadow-gray-300 rounded-full py-2 px-4">
                <div>Anywhere</div>
            ...
            <Link to={"/login"} className="flex items-center border border-gray-500 gap-2 rounded-full py-2 px-4">
