...
export default function Header() {
    const hello: any = useContext(UserContext)
    ...
    return (
        <div>
            <header className='flex justify-between'>
                ...
                <div className='shadow-md shadow-gray-300 flex border border-gray-500 rounded-full py-2 gap-2  px-4'>
                    <div>AnyWhere</div>
                ...
                <Link to={user ? '/account' : '/login'} className=' flex items-center border border-gray-500 rounded-full py-2 gap-2  px-4'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                    </svg>
                    <div className='rounded-full border border-gray overflow-hidden'>
